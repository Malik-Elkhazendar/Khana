...
- Component patterns: `.codex/skills/project-guardrails/SKILL.md §5–7`
- Navigation additions: `.codex/skills/project-guardrails/SKILL.md §10`
- Feature locations: `.codex/skills/project-index/SKILL.md`
