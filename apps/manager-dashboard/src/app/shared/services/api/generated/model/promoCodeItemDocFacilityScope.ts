...
export type PromoCodeItemDocFacilityScope =
  (typeof PromoCodeItemDocFacilityScope)[keyof typeof PromoCodeItemDocFacilityScope];

export const PromoCodeItemDocFacilityScope = {
