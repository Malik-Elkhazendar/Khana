      ...
      <div class="footer-container">
        ...
        <div class="footer-bottom">
          ...
          <div class="footer-legal">
            <a [href]="legalLinks.privacy"> سياسة الخصوصية </a>
            <span class="divider" aria-hidden="true">&bull;</span>
            <a [href]="legalLinks.terms"> شروط الخدمة </a>
            <span class="divider" aria-hidden="true">&bull;</span>
            <a [href]="legalLinks.cookies"> سياسة ملفات الارتباط </a>
          </div>
...
export class LandingFooterArComponent {
  ...
  readonly legalLinks = {
    privacy: this.createSalesMailto('طلب سياسة الخصوصية'),
    terms: this.createSalesMailto('طلب شروط الخدمة'),
    cookies: this.createSalesMailto('طلب سياسة ملفات الارتباط'),
  };
  ...
  readonly footerSections: FooterSection[] = [
    ...
    },
    {
      ...
      links: [
        {
          label: 'مركز المساعدة',
          href: this.createSalesMailto('طلب المساعدة'),
        },
        {
        ...
        {
          label: 'وثائق API',
          href: this.createSalesMailto('طلب وثائق API'),
        },
        {
          label: 'حالة المنصة',
          href: this.createSalesMailto('طلب صفحة الحالة'),
        },
      ],
    },
    {
      title: 'القانوني',
      links: [
        { label: 'سياسة الخصوصية', href: this.legalLinks.privacy },
        { label: 'شروط الخدمة', href: this.legalLinks.terms },
        { label: 'سياسة ملفات الارتباط', href: this.legalLinks.cookies },
        {
          label: 'الأمان والامتثال',
          href: this.createSalesMailto('استفسار الأمان والامتثال'),
        },
      ],
    },
  ];
