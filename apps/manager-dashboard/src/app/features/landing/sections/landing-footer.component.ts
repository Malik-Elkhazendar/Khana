      ...
      <div class="footer-container">
        ...
        <div class="footer-top">
          ...
          <div class="footer-brand">
            <a routerLink="/" class="footer-logo" aria-label="Khana - Home">
            ...
            <p class="footer-tagline">
              The Operating System for Local Booking-Based Businesses. Eliminate
              chaos. Delight customers.
            </p>
          ...
          <nav
            class="footer-nav"
            [attr.aria-label]="section.title + ' navigation'"
          >
        ...
        <div class="footer-bottom">
          <p class="copyright">
            &copy; {{ currentYear }} Khana. All rights reserved.
          </p>
