        ...
        <div class="hero-text">
          ...
          <div class="hero-badge animate-in" [style.animation-delay]="'0.1s'">
            ...
            <span class="badge-text"
              >The Operating System for Booking-Based Businesses</span
            >
          </div>
          ...
          >
            <span class="headline-line">Never Lose</span>
            <span class="headline-line">
              <span class="headline-accent">a Booking</span>
            </span>
            <span class="headline-line">Again</span>
          </h1>
          ...
          <div class="hero-actions animate-in" [style.animation-delay]="'0.6s'">
            ...
            <a
              ...
              aria-label="See how Khana works"
            >
          ...
          <div class="dashboard-container">
            ...
            <div class="floating-card card-booking" aria-hidden="true">
              ...
              <div class="floating-card-content">
                <span class="floating-card-title">Booking Confirmed</span>
                <span class="floating-card-subtitle"
                  >Court 3 &bull; 6:00 PM</span
                >
              </div>
            </div>
            ...
            <div class="floating-card card-revenue" aria-hidden="true">
              ...
              <div class="floating-card-content">
                <span class="floating-card-title">+$2,450</span>
                <span class="floating-card-subtitle">This Week</span>
              </div>
            </div>
  ...
  styles: [
    `
      ...
      .hero-text {
        ...
        padding-inline: var(
          --space-2
        ); /* Added small padding to prevent edge touching */
      ...
      .hero-stats {
        ...
        @media (max-width: 24rem) {
          /* <384px mobile fix */
          gap: var(--space-4); /* Reduce gap on small mobile */
        }
