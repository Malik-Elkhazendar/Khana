...
export class AuthService {
   ...
   */
  async register(dto: RegisterDto, tenantId?: string): Promise<UserDto> {
  ...
  async login(
    ...
    // Generate session and token IDs
    ...
    await this.refreshTokenRepository.save({
      ...
      ipAddress,
      userAgent,
      deviceFingerprint: hashDeviceFingerprint(ipAddress, userAgent),
    });
